# MIMLCA
Efficient Multiple Instance Metric Learning using Weakly Supervised Data (CVPR 2017)
...
We also provide the different splits/folds used for the Label Yahoo! News dataset. They are sufficient to reproduce the results in the paper; it is also worth noting that we mean centered the training data for each split.
